<div class="col-lg-8">
    <div class="panel panel-default" style="height:50px; background-color: #68B7D4;">
		<span style="font-size:18px; margin-left:10px; position:relative; top:13px; color:white;"><strong><span class="glyphicon glyphicon-list"></span> List of Chat Rooms</strong></span>
		<div class="pull-right" style="margin-right:10px; margin-top:7px;">
			<a href="#add_chatroom" data-toggle="modal" class="btn btn-primary" style="background-color: #2c8fb2; border-color: #68B7D4;"><span class="glyphicon glyphicon-plus"></span> Add</a>
		</div>
	</div>
