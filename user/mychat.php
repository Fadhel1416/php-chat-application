<div class="col-lg-4">
	...
	?>
		<div class="panel-heading" style="background-color: #FF975D; color:white;"><center><strong>My Chatrooms <span class="badge" style="background-color: #b26841;"><?php echo $numme; ?></span></strong></center></div>
